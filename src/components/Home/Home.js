          ...
          <div className="container">
            ...
            <div className="">
              <div className="grid-container">
                ...
                <div className="item2_1 rounded-1 c-dark">2:1</div>
            ...
            <div className="last-two-line">
              <div className="grid-container1">
                <div className="item_zero rounded-1">0</div>
                <div className="item_one rounded-1">
                  <div className="position rounded-1 c-dark">1ST 12</div>
                  <div className="grid-container2">
                    <div className="position rounded c-dark">1 TO 18</div>
                    <div className="position rounded-1 c-dark">EVEN</div>
                  </div>
                </div>
                <div className="item_two rounded-1">
                  <div className="position rounded-1 c-dark">2ND 12</div>
                  <div className="grid-container2">
                ...
                <div className="item_three rounded-1">
                  <div className="position rounded-1 c-dark">3RD 12</div>
                  <div className="grid-container2">
                    <div className="position rounded-1 c-dark">ODD</div>
                    <div className="position rounded-1 c-dark">19 TO 36</div>
                  </div>
                </div>
